      ...
      <div className='grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6'>
        <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer'>
          <input
            className='w-4 h-4  '
            type='checkbox'
            checked={selected.includes('trailering')}
            name='trailering'
        ...
        <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer'>
          <input
            className='w-4 h-4 '
            type='checkbox'
            checked={selected.includes('shelter')}
            name='shelter'
            onChange={handleCbClick}
          />
          <svg
        ...
        <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer'>
          <input
            className='w-4 h-4 '
            type='checkbox'
            checked={selected.includes('mechanic')}
            name='mechanic'
            onChange={handleCbClick}
          />
          <svg
        ...
        <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer '>
          <input
            className='w-4 h-4 '
            type='checkbox'
            checked={selected.includes('analysis')}
            name='analysis'
            onChange={handleCbClick}
          />
          <svg
        ...
        <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer '>
          <input
            className='w-4 h-4 '
            type='checkbox'
            checked={selected.includes('coaching')}
            name='coaching'
            onChange={handleCbClick}
          />
          <svg
